...
<header class="entry-header"><h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wplook' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1></header>
	...
	<img src="http://204.106.31.83/wp-content/uploads/2012/03/mceita_home_pic2.jpg" alt="" title="mceita_home_pic2" width="380" height="253" class="alignleft size-full wp-image-599" />
	</div>
<div class="options_container" style="width: 400px; float: left; display: block;"><h2>M-CEITA is your trusted advisor for adoption and effective use of Electronic Health Records (EHR). Which statement best describes you?</h2>
